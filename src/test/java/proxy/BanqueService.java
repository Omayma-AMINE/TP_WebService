...
public interface BanqueService {
    ...
    @RequestWrapper(localName = "convertEuroDH", targetNamespace = "http://ws/", className = "proxy.ConvertEuroDH")
    @ResponseWrapper(localName = "convertEuroDHResponse", targetNamespace = "http://ws/", className = "proxy.ConvertEuroDHResponse")
    @Action(input = "http://ws/BanqueService/convertEuroDHRequest", output = "http://ws/BanqueService/convertEuroDHResponse")
    public double convertEuroDH(
